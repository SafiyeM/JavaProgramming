...
5. Create a class named CharacterIdentity, and write a program
 that can identify if the given character
  is a digit or Alphabetic Character(A~Z or a~Z)
  or a special character
		...
		HINT: You may wanna check out the numbers of the characters on ASCII table or a special character
