...
public class CydeoStudents {
    public static void main(String[] args) {
        ...
        String[][] batch1Groups= {batch1Group1, batch1Group2, batch1Group3}; // two-dimensional arr is container for 1D arr
        ...
        String[][][] CydeoStundents = {batch1Groups, batch2Groups}; // multidimensional arr is container for 2D arrays


        for (String[][] eachBatch : CydeoStundents) {
