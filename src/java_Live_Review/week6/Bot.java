        ...
        while (run){
           ...
           switch (userInput){
               ...
               case "what is your age":
                   ...
                   break;
               case "who create you":
                   System.out.println("I was created bei Safiye");
                   break;
               ...
               case "shutdown":
                   ...
                   run= false; // boolean change it to false and the program stops
                   break;
               default:
...
/*
    ...
    when the program runs the user will be able to continue typing to the bot.
     Based on what the user says the bot will say something back. Use the following sample set up,
     but be creative and add more to the bot
