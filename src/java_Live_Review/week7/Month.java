...
public class Month {
    ...
    public static void main(String[] args) {
        ...
        if (month >= 1 && month <= 12){
            ...
            String[] data= {"january", "February", "March", "April", "May", "June", "July", "August",
                    "September", "October","November", "December"};

           // System.out.println(Arrays.toString(data)); this prints the whole array
            System.out.println(data[month-1]); // -1 allows the month to became an index,  because indexes start from 0
 ...
 /*
    ...
    Create a program that will define an array with all the months in order. Use this array to help print
     the full name of a month by giving a number
     Ex:
        input: 1
        output: January
