package java_live_review.week9;
...
public class Holidays {
    ...
    public static ArrayList<LocalDate> getHolidays(){
        ...
        ArrayList<LocalDate> holidays = new ArrayList<>(Arrays.asList( // we do not need reference here, we can return without using reference name
       ...
       // DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MMMM.dd.yyyy");
        ...
        for (LocalDate eachDate : getHolidays()){  // iterates through all the LocalDate objects
           if (eachDate.getMonthValue() == inputMonth){
               System.out.println(eachDate.format(DateTimeFormatter.ofPattern("MMMM d, y")));
               System.out.println(eachDate.format(DateTimeFormatter.ofPattern("MMM.dd.yyy")));
