...
public class GoogleSearch {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(eachPart)); // [About, 42,100,000, results, (0.39, seconds)]

        System.out.println(eachPart[1]); // index 1 is the number  - output: 42,100,000
        ...
        System.out.println(eachPart[3]); // (0.39
