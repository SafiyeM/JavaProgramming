...
/*
          // if we want to use scanner we need to assign our double and char in a input variable
        // after that we can call our calculate method
...
1. Create a method named calculate that can take three arguments:
	    ...
	    The method should display the calculation result of those two numbers
	    as long as the 3rd argument is a valid math operator, otherwise the method prints "Invalid Operator"
 ...
 */
   ...
   public static void ageGrups(int age){
