...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        // The objects are in the same category, so the reference type is specified in this category
        Employee[] employees = {
        ...
        System.out.println("countDriver = " + countDriver); // countDriver = 1
        System.out.println("countTeacher = " + countTeacher); // countTeacher = 1
