    ...
    public static void main(String[] args) {
        ...
        while(answer.equals("yes")){
            ...
            while (!(o == '+' || o == '-' || o == '*' || o == '/')) {  // while the operator is invalid
                System.err.println("Invalid Operator! please re-enter the math operator"); // this statement will be repeated until valid
            ...
            while(! (answer.equals("yes") || answer.equals("no"))){ // if answer no then exits
