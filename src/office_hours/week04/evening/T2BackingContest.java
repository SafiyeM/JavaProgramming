...
public class T2BackingContest {
    ...
    public static void main(String[] args) {
        ...
        //will define 3 scores for your cookies. (Those are my scores because there are three judges who rate)
        double score1=8.5;
        double score2=7.9;
        double score3=8.3;
        ...
        } else if (avg<firstPersonAvg && avg <secondPersonAvg) {
            //if avg is smaller than two of them my place is third
