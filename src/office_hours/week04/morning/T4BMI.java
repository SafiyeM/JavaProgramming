...
public class T4BMI {
	...
	Create a program that will calculate your BMI.
	 Declare and assign the values for a mass (in kilograms) and height (in meters)
	...
	sample data to use:
        ...
        double mass = 90, height = 1.8;

        //the kilograms need to be more than 40 and less than 185
        //the height also needs to be more than 1.2 and less than 2.5
        ...
        if ((mass >= 40 && mass <= 185) && (height >= 1.2 && height <= 2.5)) {
            ...
            report = "Mass:" + mass + " kg | height: " + height + " m\nBMI: " + bmi +
                    " - ";
