package src.office_Hours.week08;
...
public class T3ReverseEach {
   ...
   public static String[] reverseEach(String[] words){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(reverseEach(arr))); // [naC, uoy, nioj, eht, maet]
...
T3ReverseEach [array, loop, String]
    ...
    Create a program that will define a String array with some words.
    Reverse each given element and assign them to a new array for all the reverse words
