...
public class MusicPlaylist {
    ...
    */
    ...
    create a method next()
        it is a void method with no parameters, but whenever it runs, the current track number is updated by one
    */
    ...
    create a method removeSong()
        it is a void method with no parameters, but whenever it runs a song, is removed from the playlist so
         reduce the number of songs by one
    */
