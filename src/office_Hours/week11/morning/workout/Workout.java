package src.office_Hours.week11.morning.workout;
...
public class Workout {
    ...
    public void setName(String name) { //bench
      ...
      boolean isValid = true;
        ...
        for (int i = 0; i < name.length(); i++) {
            if (!Character.isLetter(name.charAt(i)) && name.charAt(i) != ' ' ){ // checks the character is not a letter or space
                isValid = false;
                break;
            }
        }
