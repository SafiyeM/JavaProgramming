package office_Hours.week10.morning;
...
public class T1Reservation {
    ...
    public static void main(String[] args) {
        ...
        boolean onWeekend = dayInWeek == 5 || dayInWeek == 6 || dayInWeek == 7;  //Or  dateTime.getDayOfWeek().getValue() >=5;


        if (validTime && onWeekend) {
            System.out.println("Booked for " + dateTime.format(DateTimeFormatter.ofPattern("MMM/d/yy | h:mm a "))); // pattern ->  Apr/16/23 | 5:00 PM
                                                     // format(DateTimeFormatter.ISO_DATE_TIME) // pattern -> 2023-04-16T17:00:00
        } else {
...
T1Reservation [LocalDateTime, Scanner, conditional]
    ...
    Here are the restrictions:
        ...
        - Here is some days when reservations are booked: if the day selected is one of these print Sorry this date is all booked
            November 23
            December 24
