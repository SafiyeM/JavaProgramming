...
T4CharCase [variables, if statement, relational operator]
    ...
    Create a program that will define a char variable, which will only be defined as a letter (a-z).
    The character can be defined in uppercase or lowercase, and we want to determine which one it is
